...
(function () {
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyB5KvRMNIhu63jXRADRDeTyo-sEGO1m3m4",
      authDomain: "library-app47.firebaseapp.com",
      databaseURL: "https://library-app47.firebaseio.com",
      projectId: "library-app47",
      storageBucket: "library-app47.appspot.com",
      messagingSenderId: "892850063317",
      appId: "1:892850063317:web:d8521a011f4fa5efd65f5c",
      measurementId: "G-YGFTDHCW74"
    };
...
formButton.addEventListener('click', () => {
    ...
    let interval = setTimeout(() => {addButton.click()},500);
});
  ...
  function render() {
    ...
    for (let i = 0; i< myLibrary.length; i++) {
        ...
        card[i].classList.add('card','text-center','bg-secondary','text-light');
        cardBody[i].classList.add('card-body','d-flex','flex-column','justify-content-center');
        ...
        anchs[i].classList.add('btn','btn-primary','btn-sm','align-self-center','bg-warning');
        anchs[i].setAttribute('href','#bookContainer');
        removeBook[i].classList.add('btn','btn-primary','btn-sm','align-self-center','bg-warning','mt-4');
